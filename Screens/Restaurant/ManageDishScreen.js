...
const InsertDishScreen = props => {
  ...
  async function pushDish(vegan, noLactose, vegetarian, glutenFree, dryFruit, fish) {
    ...
    props.navigation.navigate('Menu', {dishName:name});
  }
             ...
             <Text style={styles.loginText}>Choose the course *</Text>
              ...
              onPress={() => {
                if (!name) {
                  ...
                  Alert.alert("You have to choose am Image")
                } else {
                pushDish(isSelected1, isSelected2, isSelected3, isSelected4, isSelected5, isSelected6); props.navigation.navigate("Menu")}}} style={styles.loginBtn}>
