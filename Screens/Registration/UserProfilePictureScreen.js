...
export default function UserProfilePictureScreen(props) {
    ...
    if (!image) {
      ...
      try {
        ...
        firebase.storage().ref(filename).getDownloadURL().then((url)=>{
          firebase.firestore().collection('Clients').doc(id.toString()).update({
              Photo: url
            })
  ...
  return (
      <SafeAreaView style={styles.containerUpload}>
        ...
        <View style={styles.imageContainer}>
          ...
          <Image style={{width:width/1.7, height: height/3.6, marginTop: height/7}} source={require('../../assets/UserPic.png')} />
        </View>
      </SafeAreaView>
