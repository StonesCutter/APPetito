...
import { SafeAreaView, Image, View, Platform, Text, TouchableOpacity, Alert, Dimensions, ScrollView} from 'react-native';
import * as ImagePicker from 'expo-image-picker';
import {styles} from '../Styles/style'
import {IdContext} from '../Context'

const { width, height } = Dimensions.get('screen');
const thumbMeasure = (width)/3;
const thumbMeasure1 = (width + 5);
    ...
    <ScrollView style={{ width: width, height: height, backgroundColor: "white" }}>
      <SafeAreaView style={styles.containerUpload}>
        <Image style={{
          width: thumbMeasure1,
          height: thumbMeasure}}
          source={require('../assets/backgroundUpload.png')} />
